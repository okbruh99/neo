...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-background/90 dark:from-[#121212] dark:to-[#0a0a0a] flex flex-col items-center justify-center p-4">
      <motion.div
      ...
      >
        <div className="mb-8 text-center relative">
          <Button variant="ghost" size="icon" className="absolute left-0 top-0" onClick={() => router.push("/")}>
            ...
            <div className="flex items-center justify-center gap-2">
              <div className="relative h-10 w-10 overflow-hidden rounded-full bg-gradient-to-br from-primary to-primary-foreground dark:from-[#00D084] dark:to-[#3B82F6]">
                <div className="absolute inset-0 flex items-center justify-center text-background dark:text-[#121212]">
                  <span className="font-bold text-xl">NT</span>
                </div>
              </div>
          ...
          <p className="mt-2 text-sm text-muted-foreground">Sign up to start trading items with others</p>
        </div>

        <div className="rounded-lg border border-border/40 bg-background/40 p-6 backdrop-blur-md dark:border-border/20 dark:bg-[#1a1a1a]/40">
              ...
              <div className="mt-2 space-y-1 text-xs">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-1">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className={hasUpperCase ? "text-green-500" : "text-muted-foreground"}>Uppercase letter</span>
                  </div>
                  <div className="flex items-center gap-1">
                    {hasLowerCase ? (
                      <Check className="h-3 w-3 text-green-500" />
                    ...
                    <span className={hasLowerCase ? "text-green-500" : "text-muted-foreground"}>Lowercase letter</span>
                  </div>
                  <div className="flex items-center gap-1">
                    {hasNumber ? <Check className="h-3 w-3 text-green-500" /> : <X className="h-3 w-3 text-red-500" />}
                    <span className={hasNumber ? "text-green-500" : "text-muted-foreground"}>Number</span>
                  </div>
                  <div className="flex items-center gap-1">
                    {hasSpecialChar ? (
                      <Check className="h-3 w-3 text-green-500" />
